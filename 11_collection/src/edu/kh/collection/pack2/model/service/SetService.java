...
//		Set<String> set = new LinkedHashSet<String>();
		...
		// 1. boolean add(E e) : 추가, 반환형 boolean
		set.add("네이버");
		set.add("카카오");
		set.add("라인");
		set.add("쿠팡");
	...
	public void method2() { 
		...
		List<String> list = new ArrayList<String>(set); // 생성자에 매개변수로 set을 전달
		// List안에 String 타입의 set이 들어감
	...
	public void method3() {
		...
		// method1, 2 는 이미 equals(), hashCode() 오버라이딩된 String, Integer를
		// 사용하고 있어서 중복제거가 된다
		// method1 에서 Set<String> set = new HashSet<String>();
		// method2 에서 Set<String> set = new HashSet<String>();
		// 둘다 String 사용중
		...
		// hashCode(), equals() 오버라이딩 필수적을 진행해야한다!!!!!!!
		// ********************************************************
	 ...
	 * Wrapper 클래스는 int i = 0; 같은 거를 객체화시키는 거다
	...
	public void method4() {
		...
		// 컬렉션에는 <> 안에 int, char 같은 기본자료형 안됨 객체만 가능
