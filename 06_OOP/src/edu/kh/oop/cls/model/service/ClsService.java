...
//		System.out.println(v4);
	...
	public void ex2() {
		...
		// 노란줄은 실행에 문제가 없음, 하지만 더 나은 코드를 쓰라는 말
		
		Student.schoolName = "KH정보교육원";
		
		System.out.println(Student.schoolName); // KH정보교육원
		System.out.println(std1.schoolName); // KH정보교육원
		System.out.println(std2.schoolName); // KH정보교육원
