...
public class Run {
	public static void main(String[] args) {
		...
		// 1. 객체배열을 크기 3으로 할당 한 뒤 3개의 생성자를 각각 이용하여 객체 생성 후 출력
		...
		//System.out.println("emp[0] : " + Arrays.deepToString(arr[0]));
...
//		
//		System.out.println("emp[0] : " + arr[0].information());
//		System.out.println("emp[1] : " + arr[1].information());
//
//		System.out.println("=====================================================================");
//		
//		
//		int total0 = (arr[0].getSalary() + (int)((double)arr[0].getSalary() * arr[0].getBonusPoint())) * 12;
//		
//		System.out.println(arr[0].getEmpName() + "의 연봉 : " + total0 );
//		
