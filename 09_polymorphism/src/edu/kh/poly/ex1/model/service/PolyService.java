...
public class PolyService {
	...
	// 전달받은 Car 또는 자식객체(Tesla, Spark)의 엔진, 연료, 바퀴갯수를 추력하는 메서드
	...
	public void ex4() {
		...
		// Spark 참조변수로 Tesla를 참조하려고하면 문제 발생
		
		// 해결방법 : instranceof 와 같이 사용해야한다
