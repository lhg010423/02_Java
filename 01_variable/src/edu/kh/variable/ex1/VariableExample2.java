...
public class VariableExample2 {
	public static void main(String[] args) {
		 ...
		 * 
		 * 
		 * String은 자료형이 아니라 참조형이다
		 * */
		
		// 변수 선언 : 메모리에 값을 저장할 공간을 할달 하는 것
		...
		// 1.2345 까지만 쓰면 에러남(double 자료형이라서)
		 ...
		 *   'B' 문자 그대로 대입되면 변수에 숫자 66으로 변환되어 저어
		...
		int int_Number; // 자바는 카멜표기법 사용
						...
						// MEMBER_NAME
		// 5.카멜표기법
		char helloWorldAppleBanana;
		
		// 6. 분수명은 언어를 가리지 않음(하지만 쓰지 않음)
		int 정수1번;
		double 실수2번 = 3.14;
