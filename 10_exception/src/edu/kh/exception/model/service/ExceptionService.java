...
public class ExceptionService {
	...
	public void ex1() {
		...
		// 발생하는 예외중 일부 예외 try-catch 구문 사용 안해도
	...
	public void ex2() {
		...
		try {
			...
			// InputMismatchException -> 이것도 import 해야함
	...
	public void methodC() throws IOException{
		...
		// 이렇게 하면 methodC만 예외처리할 수 있음
		// methodA, B 도 따로 또해야하는 번거로움이 있음
		/*
		try {
			throw new IOException();
		} catch(IOException e) {
